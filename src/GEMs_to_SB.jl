...
# --- 🚀 Usage Example ---
# This shows how you would use the function from the new module.
using .GEMProcessor

# --- Configuration ---
# Set the path to your folder containing the .xml files
const INPUT_FOLDER = "path/to/your/xml_files"
    
# Set the path where you want to save the new sample folders
const OUTPUT_FOLDER = "path/to/your/sbml_output"
    
# Run the exported conversion function
convert_xml_to_sbml(INPUT_FOLDER, OUTPUT_FOLDER)
